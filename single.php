...
<?php if( $thumb ) { ?>
	<section class="post-hero">
		<figure class="post-hero--bg bg-cover mb-0" style="background-image: url(<?php echo $thumb; ?>);">
			<img class="sr-only" src="<?php echo get_the_post_thumbnail_url( $post_id, 'thumbnail' ); ?>" alt="<?php esc_attr( the_title() ); ?>">
			<figcaption class="sr-only"><?php esc_attr( the_title() ); ?></figcaption>
		</figure>
	</section>
<?php } ?>
...
<section class="py-5">
	<div class="ss-pad">
		<div class="py-md-5 px-0 container mod-content">
			<h1 class="txt-h3 text-center mb-3"><?php the_title(); ?></h1>
		</div>
	</div>
